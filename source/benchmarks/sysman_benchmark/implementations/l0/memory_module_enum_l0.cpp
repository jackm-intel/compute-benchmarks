...
static TestResult run(const MemoryModuleEnumArguments &arguments, Statistics &statistics) {
...
static RegisterTestCaseImplementation<MemoryModuleEnum> registerTestCase(run, Api::L0);
